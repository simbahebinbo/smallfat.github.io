...
![image](http://latex.codecogs.com/gif.latex?\\g^{x³-3x²+2x} \ (mod\ n)= (g^{x³})^1 · (g^{x²})^{-3} ·(g^x)^2 \ (mod\ n)  = g^{1x³} · (g^{-3x²})·(g^{2x}) \ (mod\ n))
...
![image](http://latex.codecogs.com/gif.latex?\\g^{p(s)%20*%20%CE%B4})

![image](http://latex.codecogs.com/gif.latex?\\g^{p%27(s)%20*%20%CE%B4})

![image](http://latex.codecogs.com/gif.latex?\\g^{h(s)%20*%20%CE%B4})


verifier:
1.  验证

![image](http://latex.codecogs.com/gif.latex?\\g^{p(s)%20*%20%CE%B4}%20=%20g^{h(s)%20*%20%CE%B4%20*%20t(s)})

![image](http://latex.codecogs.com/gif.latex?\\g^{p%27(s)%20*%20%CE%B4}%20=%20g^{p(s)%20*%20%CE%B4%20*%20q})
